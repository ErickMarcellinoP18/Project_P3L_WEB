...
<head>
    <title>Atma Kitchen - Create Pengeluaran Lain</title>
                        ...
                        <div class="card-body p-0">
                            <div class="p-5">
                                <div class="text-center">
                                    <h1 class="h4 text-gray-900 mb-4">Add Pengeluaran Lain</h1>
                                </div>
                                <form class="user" action="{{ route('pengeluaran_lain.store') }}" method="POST"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number"
                                            ...
                                            id="inputTotalPengeluaran" placeholder="Total Pengeluaran"
                                            value="{{ old('total_pengeluaran') }}" name="total_pengeluaran">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-4">
                                            ...
                                            <input type="date"
                                                ...
                                                value="{{ old('tanggal_pengeluaran') }}" name="tanggal_pengeluaran">
