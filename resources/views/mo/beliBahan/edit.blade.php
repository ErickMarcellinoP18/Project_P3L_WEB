                        ...
                        <div class="card-body p-0">
                            <div class="p-5">
                                <div class="text-center">
                                    <h1 class="h4 text-gray-900 mb-4">Edit Pembelian Bahan Baku</h1>
                                </div>

                                <form class="user"
                                    action="{{ route('beliBahan.update', $pembelian_bahan_baku->id_bahan_baku) }}"
                                    ...
                                    <div class="form-group row">
                                        <div class="col-sm-4 mb-3 mb-sm-0">
                                            ...
                                            <input type="number"
                                                ...
                                                value="{{ old('harga_bahan_baku', $pembelian_bahan_baku->harga_bahan_baku) }}"
                                        ...
                                        <div class="col-sm-4">
                                            ...
                                            <input type="number"
                                                ...
                                                value="{{ old('kuantitas', $pembelian_bahan_baku->kuantitas) }}"
                                                name="kuantitas">
                                            @error('kuantitas')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                        ...
                                        <select class="form-control  @error('nama_bahan') is-invalid @enderror"
                                            ...
                                            @foreach ($bahan_baku as $item)
                                                <option value="{{ $item->id_bahan_baku }}"
                                                    {{ $item->id_bahan_baku === $pembelian_bahan_baku->bahan_baku->id_bahan_baku ? 'selected' : '' }}>
                                                    {{ $item->nama_bahan }}
                                                </option>
                                            @endforeach
                                        </select>
